...
import PodActions from "./_components/pod-actions";
...
const KubernetesDetails = () => {
  ...
  const filteredPods = mockKubernetesData.pods.filter((pod) => {
    ...
    const matchesSecurity =
      securityFilter === "all" || pod.securityStatus === securityFilter;
            ...
            <TableBody>
              {filteredPods.map((pod) => (
                <TableRow key={pod.name}>
                  ...
                  <TableCell>
                    <PodActions pod={`${pod.namespace}/${pod.name}`}/>
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
                ...
                <TableRow key={node.name}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        router.push(`/kubernetes/nodes/${node.ip}`)
                      }
                    >
                      Details
                    </Button>
                ...
                <TableRow key={namespace.name}>
                  ...
                  <TableCell>
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/kubernetes/namespaces/${namespace.name}`
                        )
                      }
                    >
                      Details
